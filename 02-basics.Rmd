...
**Try it: Open [exercise0_data.sav](https://github.com/CSCAR/workshop-spss/raw/master/data/exercise0/exercise0_data.sav)**
...
**Try it: Open [exercise0_output.spv](https://github.com/CSCAR/workshop-spss/raw/master/data/exercise0/exercise0_output.spv)**
...
**Try it: Open [exercise0_syntax.sps](https://github.com/CSCAR/workshop-spss/raw/master/data/exercise0/exercise0_syntax.sps)** (Right-click & Save-as)
...
```
VARIABLE LABELS age \"Age\" sex \"Sex\" income \"Annual income in thousands\" ethnic \"Ethnic category\".
```

**5) Labeling values of a variable**

```
VALUE LABELS sex \'M\' \"Male\" \'F\' \"Female\" / ethnic 1 \"European American\" 2 \"African American\" 3 \"Asian American\".
```
...
**Try it: In Data View for [exercise0_data.sav](https://github.com/CSCAR/workshop-spss/raw/master/data/exercise0/exercise0_data.sav), select Analyze -
...
[![](./media/spss-image11.png){width="5.59375in" height="2.357273622047244in"} ](./media/spss-image11.png){target="_blank"}
...
Open [exercise1\_data.sav](https://github.com/CSCAR/workshop-spss/raw/master/data/exercise1/exercise1_data.sav) and see what guidelines we have ignored.
...
[![](./media/spss-image13.png){width="6.496790244969379in" height="3.3645833333333335in"}](./media/spss-image13.png){target="_blank"}
...
Open [exercise2_data.xls](https://github.com/CSCAR/workshop-spss/raw/master/data/exercise2/exercise2_data.xls) (an Excel file). Modify this Excel file such that
