...
closer to the Excel end of the spectrum which makes it convenient to
...
**Try it: In Data View for [exercise0_data.sav](https://github.com/CSCAR/workshop-spss/raw/master/data/exercise0/exercise0_data.sav), select Analyze -> Descriptive Statistics -> Descriptives.**
