...
guidelines set out above. Open [exercise1_data.sav](https://github.com/CSCAR/workshop-spss/raw/master/data/exercise1/exercise1_data.sav) and see what guidelines
we have ignored.
...
Open [exercise2_data.sav](https://github.com/CSCAR/workshop-spss/raw/master/data/exercise2/exercise2_data.sav) (an Excel file). Modify this Excel file such that
...
[![](./media/spss-exer-image8.png){width="6.0625in" height="3.320896762904637in"}](./media/spss-exer-image8.png){target="_blank"}
...
Open [exercise5_data.sav](https://github.com/CSCAR/workshop-spss/raw/master/data/exercise5/exercise5_data.sav).
...
[![](./media/OCC_age.png){width="6in" height="4in"}](./media/OCC_age.png){target="_blank"}

### Exercise 6

Convert [exercise6_data.sav](https://github.com/CSCAR/workshop-spss/raw/master/data/exercise6/exercise6_data.sav) from "Wide" format to "Long" format

**Solution: **

-   Open [exercise6_data.sav](https://github.com/CSCAR/workshop-spss/raw/master/data/exercise6/exercise6_data.sav)
...
Convert [exercise7_data.sav](https://github.com/CSCAR/workshop-spss/raw/master/data/exercise7/exercise7_data.sav) from "Long" format to "Wide" format

**Solution: **

-   Open [exercise7_data.sav](https://github.com/CSCAR/workshop-spss/raw/master/data/exercise7/exercise7_data.sav)
...
Open the dataset [exercise8_data.sav](https://github.com/CSCAR/workshop-spss/raw/master/data/exercise8/exercise8_data.sav)
...
[![](./media/EDUC_sex.png){width="5in" height="2in"}](./media/EDUC_sex.png){target="_blank"}
...
[![](./media/spss-exer-image43.png){width="4.5in" height="4.5in"}](./media/spss-exer-image43.png){target="_blank"}
...
Open [exercisea1_data](https://github.com/CSCAR/workshop-spss/raw/master/data/exercisea1/exercisea1_data.sav). What percent of respondents said they were "Very
...
[![](./media/Happy.png){width="4in" height="3in"}](./media/Happy.png){target="_blank"}
...
Open [exercisea2_data.sav](https://github.com/CSCAR/workshop-spss/raw/master/data/exercisea2/exercisea2_data.sav).
...
[![](./media/spss-exer-image73.png){width="6in" height="8in"}](./media/spss-exer-image73.png){target="_blank"}
...
**A. From [exercisea3_data_a.sav](https://github.com/CSCAR/workshop-spss/raw/master/data/exercisea3/exercisea3_data_a.sav)**
...
**B. From [exercisea3_data_b.sav](https://github.com/CSCAR/workshop-spss/raw/master/data/exercisea3/exercisea3_data_b.sav)**
...
Open [exercisea4_data](https://github.com/CSCAR/workshop-spss/raw/master/data/exercisea4/exercisea4_data.sav).
...
[![](./media/spss-exer-image87.png){width="6.498647200349956in" height="6.051683070866142in"}](./media/spss-exer-image87.png){target="_blank"}

[![](./media/spss-exer-image88.png){width="8in" height="6.5in"}](./media/spss-exer-image88.png){target="_blank"}

[![](./media/spss-exer-image89.png){width="8in" height="6.5in"}](./media/spss-exer-image89.png){target="_blank"}
...
[![](./media/spss-exer-image92.png){width="8in" height="7in"}](./media/spss-exer-image92.png){target="_blank"}
...
[![](./media/spss-exer-image101.png){width="8in" height="6.5in"}](./media/spss-exer-image101.png){target="_blank"}
...
[![](./media/spss-exer-image122.png){width="8in" height="6.7in"}](./media/spss-exer-image122.png){target="_blank"}
...
[![](./media/Reg4.png){width="8in" height="8in"}](./media/Reg4.png){target="_blank"}
...
[![](./media/Reg6.png){width="8in" height="8in"}](./media/Reg6.png){target="_blank"}
...
[![](./media/Reg8.png){width="8in" height="8in"}](./media/Reg8.png){target="_blank"}
...
[![](./media/spss-exer-image150.png){width="7in" height="5.6in"}](./media/spss-exer-image150.png){target="_blank"}
...
Open [exercisea5_data](https://github.com/CSCAR/workshop-spss/raw/master/data/exercisea5/exercisea5_data.sav)
...
[![](./media/spss-exer-image155.png){width="5.610416666666667in" height="4.129861111111111in"}](./media/spss-exer-image155.png){target="_blank"}
...
[![](./media/spss-exer-image156.png){width="4.285416666666666in" height="1.9743055555555555in"}](./media/spss-exer-image156.png){target="_blank"}
...
[![](./media/spss-exer-image157.png){width="2.6625in" height="1.0256944444444445in"}](./media/spss-exer-image157.png){target="_blank"}
...
[![](./media/spss-exer-image158.png){width="6.285416666666666in" height="2.3506944444444446in"}](./media/spss-exer-image158.png){target="_blank"}
...
[![](./media/spss-exer-image159.png){width="5.961111111111111in" height="0.8444444444444444in"}](./media/spss-exer-image159.png){target="_blank"}
...
[![](./media/spss-exer-image160.png){width="6.285416666666666in" height="2.1430555555555557in"}](./media/spss-exer-image160.png){target="_blank"}
...
[![](./media/spss-exer-image161.png){width="5.909027777777778in" height="1.2465277777777777in"}](./media/spss-exer-image161.png){target="_blank"}
...
[![](./media/spss-exer-image164.png){width="6.285416666666666in" height="2.1430555555555557in"}](./media/spss-exer-image164.png){target="_blank"}
...
[![](./media/spss-exer-image165.png){width="5.909027777777778in" height="1.2465277777777777in"}](./media/spss-exer-image165.png){target="_blank"}
...
[![](./media/spss-exer-image168.png){width="4.285416666666666in" height="1.9743055555555555in"}](./media/spss-exer-image168.png){target="_blank"}
...
[![](./media/spss-exer-image169.png){width="5.870138888888889in" height="1.8701388888888888in"}](./media/spss-exer-image169.png){target="_blank"}
...
[![](./media/spss-exer-image170.png){width="3.285416666666667in" height="1.0in"}](./media/spss-exer-image170.png){target="_blank"}
...
[![](./media/spss-exer-image171.png){width="5.870138888888889in" height="2.129861111111111in"}](./media/spss-exer-image171.png){target="_blank"}
...
1)  Investigate [cars\_wave1.xls](https://github.com/CSCAR/workshop-spss/raw/master/data/finalproject/cars_wave1.xls) and
    [cars\_wave2.xls](https://github.com/CSCAR/workshop-spss/raw/master/data/finalproject/cars_wave2.xls) and prepare the data
    for SPSS
...
[![](./media/spss-exer-image173.png){width="6.5in" height="2.324293525809274in"}](./media/spss-exer-image173.png){target="_blank"}

[![](./media/spss-exer-image174.png){width="3.295138888888889in" height="2.295138888888889in"}](./media/spss-exer-image174.png){target="_blank"}
...
[![](./media/spss-exer-image175.png){width="5.590277777777778in" height="2.295138888888889in"}](./media/spss-exer-image175.png){target="_blank"}
...
[![](./media/spss-exer-image176.png){width="4.508333333333334in" height="3.967361111111111in"}](./media/spss-exer-image176.png){target="_blank"}

[![](./media/spss-exer-image177.png){width="4.926388888888889in" height="1.9673611111111111in"}](./media/spss-exer-image177.png){target="_blank"}

[![](./media/spss-exer-image178.png){width="5.0in" height="2.4180555555555556in"}](./media/spss-exer-image178.png){target="_blank"}

[![](./media/spss-exer-image179.png){width="4.909722222222222in" height="1.7541666666666667in"}](./media/spss-exer-image179.png){target="_blank"}
