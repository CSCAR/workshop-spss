...
![](./media/spss-image53.png){width="9.269444444444444in"
height="10in"}
...
![](./media/spss-image55.png){width="5.0in" height="2.4583333333333335in"}
![](./media/spss-image56.png){width="5.0in" height="2.2395833333333335in"}
...
![](./media/spss-image57.png){width="4.895833333333333in"
height="3.0833333333333335in"}

![](./media/Desc_stats.png){width="4.895833333333333in"
height="3.0833333333333335in"}
...
![](./media/spss-image58.png){width="6.5in" height="3.2291666666666665in"}

![](./media/spss-image59.png){width="4.416666666666667in" height="2.0in"}

![](./media/Desc_stats2.png){width="4.895833333333333in"
height="1.5in"}
...
![](./media/spss-image60.png){width="6.5in" height="4.488888888888889in"}
...
![](./media/spss-image61.png){width="5.05625in"
height="4.614583333333333in"}![](./media/spss-image62.png){width="5.18125in"
...
![](./media/spss-image63.png){width="3.6875in" height="1.6041666666666667in"}
![](./media/spss-image64.png){width="4.552083333333333in" height="4.71875in"}

**Try it: Use [section5_1_data.sav](https://github.com/CSCAR/workshop-spss/raw/master/data/section5_1_data.sav). Create a simple bar chart for
"Region". **

![](./media/spss-image65.png){width="3.5377318460192475in"
height="4.020833333333333in"}![](./media/spss-image62.png){width="5.18125in"
...
![https://s15-us2.ixquick.com/cgi-bin/serveimage?url=https:%2F%2Fupload.wikimedia.org%2Fwikipedia%2Fcommons%2Fthumb%2Fd%2Fdf%2FBellcurve.svg%2F2000px-Bellcurve.svg.png&sp=e6ff634ca3ce0a0de1bfab4490a45ca7](./media/spss-image66.png){width="5.05625in"
...
![](./media/spss-image67.png){width="4.0625in" height="2.7527777777777778in"}

![](./media/spss-image68.png){width="4.5729166666666665in"
height="2.8314818460192477in"}

![](./media/spss-image69.png){width="4.6979166666666665in"
height="2.7043985126859145in"}

![](./media/spss-image70.png){width="4.5625in"
...
![](./media/spss-image71.png){width="3.8541666666666665in" height="3.0in"}

For the Scatterplot in SPSS, select Graphs - Legacy Dialogs
- Scatter/Dot, choose "Simple Scatter", and click "Define".

![](./media/spss-image64.png){width="3.880323709536308in"
height="3.9676115485564303in"}

![](./media/spss-image63.png){width="3.18125in"
...
![](./media/spss-image72.png){width="5in"


![](./media/Correl.png){width="5in"
height="3.25in"}
...
![](./media/spss-image73.png){width="4.30625in" height="4.572916666666667in"}

![](./media/spss-image74.png){width="6.5in" height="5.197916666666667in"}
...
![](./media/spss-image78.png){width="4.0in" height="3.7395833333333335in"}

![](./media/spss-image79.png){width="2.6145833333333335in"
height="2.8777777777777778in"}

![](./media/Chi_sq.png){width="5in" height="5in"}

![](./media/spss-image80.png){width="4.40625in" height="2.75in"}
...
![](./media/spss-image81.png){width="4.229166666666667in"
height="2.3645833333333335in"}

![](./media/spss-image82.png){width="4.90625in"
...
![](./media/spss-image83.png){width="2.0104166666666665in"
height="2.2916666666666665in"}

![](./media/spss-image84.png){width="4.114583333333333in"
...
![](./media/spss-image85.png){width="4.895833333333333in"
height="3.0416666666666665in"}

![](./media/spss-image86.png){width="2.4791666666666665in"
height="2.0416666666666665in"}


![](./media/Compare_means1.png){width="7in" height="3.5in"}
...
![](./media/spss-image87.png){width="3.6875in" height="1.75in"}

![](./media/Compare_means2.png){width="4in" height="2in"}
...
![](./media/spss-image88.png){width="4.2604166666666665in"
height="3.1979166666666665in"}

![](./media/spss-image89.png){width="5.5625in" height="4.083333333333333in"}
...
![](./media/spss-image90.png){width="6.05625in"
...
![](./media/spss-image91.png){width="6.18125in"
height="3.3645833333333335in"}

![](./media/Paired.png){width="7in"
height="5in"}
...
Check the Chi-square box under "Statistics"
...
Button is fourth from the left at the top of the Data View screen
...
Select "Weight Cases by" and use Var0001 for the data below

Analyze - Descriptive Statistics - Crosstabs

Enter in Var0002 for rows and Var0003 for columns for the data below
