...
The last option is the box labeled "Indicate case sourse as variable".
...
Variables procedure. The first step is to identify the exernal file that
...
attachesthe appropriate information to the individuals.
