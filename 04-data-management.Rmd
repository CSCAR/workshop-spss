...
Data for this section: [section4_data.sav](https://github.com/CSCAR/workshop-spss/raw/master/data/section4_data.sav)
...
![](./media/spss-image42.png){width="4.041666666666667in"
...
![](./media/spss-image43.png){width="5.239583333333333in"
height="4.729166666666667in"}

![](./media/spss-image44.png){width="6.5in" height="4.03125in"}
...
![](./media/spss-image45.png){width="3.96875in"
...
![](./media/spss-image46.png){width="5.239583333333333in" height="5.3125in"}
...
**Try it: Use [section4_data.sav](https://github.com/CSCAR/workshop-spss/raw/master/data/section4_data.sav). Select only observations with
Education = 1 for analysis. **

![](./media/spss-image47.png){width="6.05625in" height="3.84375in"}
![](./media/spss-image48.png){width="6.5in" height="2.7291666666666665in"}
...
![](./media/spss-image49.png){width="4.625in" height="3.5833333333333335in"}

**Try it: Use [section4_data.sav](https://github.com/CSCAR/workshop-spss/raw/master/data/section4_data.sav). Obtain the descriptive statistics for
DepScale\_01 for males and females separately. Hint: Select Analyze -
Descriptive Statistics - Descriptives.**

![](./media/spss-image50.png){width="3.93125in" height="2.875in"}

![](./media/spss-image-splitfile.png){width="5in" height="1.5in"}
...
Statistics - Descriptives and moving "Age of Respondent (age)"
...
ESIN\\Notebook\\MODIFY\\Slide13.JPG](./media/spss-image51.jpeg){width="5.989583333333333in"
...
![S:\\dept\\Workshops\\Workshop Slides\\SPSS Intro for
ESIN\\Notebook\\MODIFY\\Slide27.JPG](./media/spss-image52.jpeg){width="5.229166666666667in"
