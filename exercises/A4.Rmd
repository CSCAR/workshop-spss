...
![](./media/spss-exer-image75.png){width="6.16875in"
...
![](./media/spss-exer-image82.png){width="2.5416666666666665in"
...
![](./media/spss-exer-image86.png){width="6.5in"
height="1.5304133858267717in"}

The descriptive statistics table above indicates that males earn more
than females on average.

![](./media/spss-exer-image87.png){width="4.498647200349956in"
height="4.051683070866142in"}

![](./media/spss-exer-image88.png){width="4.400516185476816in"
height="3.51374343832021in"}

![](./media/spss-exer-image89.png){width="4.872189413823272in"
...
![](./media/spss-exer-image92.png){width="4.97696084864392in"
...
height="2.3173534558180227in"}![](./media/spss-exer-image94.png){width="2.4805555555555556in"
height="2.0388888888888888in"}

![](./media/spss-exer-image95.png){width="6.207638888888889in"
height="0.9611111111111111in"}

![](./media/spss-exer-image96.png){width="6.5in"
...
![](./media/spss-exer-image98.png){width="5.090972222222222in"
...
![](./media/spss-exer-image101.png){width="4.719426946631671in"
...
![](./media/spss-exer-image104.png){width="4.298611111111111in"
height="1.0777777777777777in"}

Notice that the regression menu provides the correlation between the
variables included in the model.

![](./media/spss-exer-image105.png){width="5.090972222222222in"
...
![](./media/spss-exer-image106.png){width="4.052083333333333in"
height="1.0777777777777777in"}
...
![](./media/spss-exer-image107.png){width="5.50625in"
...
![](./media/spss-exer-image108.png){width="6.5in"
...
![](./media/spss-exer-image111.png){width="2.636111111111111in"
height="1.0777777777777777in"}
...
![](./media/spss-exer-image112.png){width="5.246527777777778in"
height="2.4027777777777777in"}

The parameter estimates table below provides the same information as the
coefficients table above.

![](./media/spss-exer-image113.png){width="5.753472222222222in"
...
![](./media/spss-exer-image118.png){width="4.8622834645669295in"
...
![](./media/spss-exer-image127.png){width="2.6493055555555554in"
height="0.9611111111111111in"}
...
![](./media/spss-exer-image128.png){width="3.2708333333333335in"
...
![](./media/spss-exer-image129.png){width="5.246527777777778in"
...
![](./media/spss-exer-image130.png){width="5.753472222222222in"
...
![](./media/spss-exer-image131.png){width="3.3854166666666665in"
...
![](./media/spss-exer-image134.png){width="5.25in"
...
![](./media/spss-exer-image135.png){width="6.70844706911636in"
...
![](./media/spss-exer-image136.png){width="5.677083333333333in"
...
![](./media/spss-exer-image140.png){width="5.25in"
...
![](./media/spss-exer-image141.png){width="6.83236220472441in"
...
![](./media/spss-exer-image143.png){width="3.6354166666666665in"
...
![](./media/spss-exer-image146.png){width="2.6458333333333335in"
height="1.625in"}

The table below provides the descriptive statistics for salary broken
out by gender and rank.

![](./media/spss-exer-image147.png){width="4.03125in"
...
![](./media/spss-exer-image148.png){width="5.25in"
...
![](./media/spss-exer-image149.png){width="6.395255905511811in"
...
![](./media/spss-exer-image150.png){width="4.233467847769029in"
height="3.3854166666666665in"}
...
![](./media/spss-exer-image152.png){width="6.09375in"
...
![](./media/spss-exer-image153.png){width="4.71875in"
height="3.773487532808399in"}

![](./media/spss-exer-image154.png){width="4.552083333333333in"
